...
status2 = Status.create(user: user1, tamagotchi: tamagotchi2, happiness: 10, fullness: 10, money: 100, nickname:'BooBoo')
status3 = Status.create(user: user2, tamagotchi: tamagotchi3, happiness: 10, fullness: 10, money: 100, nickname:'Freckles')
status4 = Status.create(user: user2, tamagotchi: tamagotchi4, happiness: 10, fullness: 10, money: 100, nickname:'Snuggle Bug')
...
status7 = Status.create(user: user4, tamagotchi: tamagotchi7, happiness: 10, fullness: 10, money: 100, nickname:'bby cakes')
...
status10 = Status.create(user: user5, tamagotchi: tamagotchi10, happiness: 10, fullness: 10, money: 100, nickname:'Pickley Poo')
status11 = Status.create(user: user5, tamagotchi: tamagotchi2, happiness: 10, fullness: 10, money: 100, nickname:'Fluffy')

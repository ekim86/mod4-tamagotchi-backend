...
item8 = Item.create(name: 'lego', effect: 2, category: 'toy', price: 5, image: '/lego.png')
item9 = Item.create(name: 'dollhouse', effect: 2, category: 'toy', price: 7, image: '/dollhouse.gif')
item10 = Item.create(name: 'racecar', effect: 2, category: 'toy', price: 3, image: '/racecar.png')

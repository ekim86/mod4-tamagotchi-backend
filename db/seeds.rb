...
item1 = Item.create(name: 'iname1', effect: 2, category: 'food', price: 5)
inventory1 = Inventory.create(user: user1, item: item1, quantity: 3, image: 'https://i1.pngguru.com/preview/313/486/450/25-kawaii-food-s-sushi-illustration.jpg')

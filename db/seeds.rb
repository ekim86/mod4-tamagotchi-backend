...
status2 = Status.create(user: user1, tamagotchi: tamagotchi2, happiness: 10, fullness: 10, money: 100)
status3 = Status.create(user: user2, tamagotchi: tamagotchi3, happiness: 10, fullness: 10, money: 100)
status4 = Status.create(user: user2, tamagotchi: tamagotchi4, happiness: 10, fullness: 10, money: 100)
status5 = Status.create(user: user3, tamagotchi: tamagotchi5, happiness: 10, fullness: 10, money: 100)
status6 = Status.create(user: user3, tamagotchi: tamagotchi6, happiness: 10, fullness: 10, money: 100)
status7 = Status.create(user: user4, tamagotchi: tamagotchi7, happiness: 10, fullness: 10, money: 100)
status8 = Status.create(user: user4, tamagotchi: tamagotchi8, happiness: 10, fullness: 10, money: 100)
status9 = Status.create(user: user5, tamagotchi: tamagotchi9, happiness: 10, fullness: 10, money: 100)
status10 = Status.create(user: user5, tamagotchi: tamagotchi10, happiness: 10, fullness: 10, money: 100)
status11 = Status.create(user: user5, tamagotchi: tamagotchi2, happiness: 10, fullness: 10, money: 100)
status12 = Status.create(user: user5, tamagotchi: tamagotchi8, happiness: 10, fullness: 10, money: 100)
